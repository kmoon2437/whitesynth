...
| `0x12` | Pan | None - L63 - Center - R63<br>(`0x00` - `0x01` - `0x40` - `0x7F`) | None (`0x00`) | 이 값이 0 (`0x00`) 이 아닐 경우 채널의 control change의 pan 설정값을 무시하고 여기서 설정한 pan 값에 강제로 맞춘다. |
...
| `0x12` | Pan | None - L63 - Center - R63<br>(`0x00` - `0x01` - `0x40` - `0x7F`) | None (`0x00`) | 이 값이 0 (`0x00`) 이 아닐 경우 채널 cc의 pan 설정값을 무시하고 여기서 설정한 pan 값에 강제로 맞춘다. |
