...
- 멀티 이펙트(multi effect) 채널 1개당 16개 + 공용 멀티 이펙트(sc 8820의 insertion effect와 비슷하게 쓰려고 만든 거) 1포트당 16개
- docs 폴더에 어떻게 만들지 사용설명서 형태로 문서를 만들어 놓았음. 완성된 게 아니므로 자주 바뀔 수 있음
